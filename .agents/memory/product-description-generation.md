...
**How to apply:** When adding a product field, category, or SEO keyword rule, update the shared generator and validate all published products. State a fact directly when it exists; omit the sentence when it does not. Keep Arabic keyword phrases natural and use the store's confirmed policies only.